...
func Test_warnOnInvalidCloudConfigLogsWarningOnInvalidContent(t *testing.T) {
	...
	c.warnOnInvalidCloudConfig("This is not valid")
	if !strings.Contains(logBuf.String(), "WARN") {
		t.Errorf("This should trigger a warning log")
	}
}
...
func Test_warnOnInvalidCloudConfigRecognizesGzip(t *testing.T) {
	...
	c.warnOnInvalidCloudConfig(buf.String())
	if strings.Contains(logBuf.String(), "WARN") {
